...
class PromoBanner(Base, TimestampMixin):
    ...
    placement: Mapped[PromoPlacement] = mapped_column(
        SQLEnum(PromoPlacement), default=PromoPlacement.home_carousel, nullable=False
    )
    target_type: Mapped[PromoTargetType] = mapped_column(
        SQLEnum(PromoTargetType), default=PromoTargetType.none, nullable=False
    )
...
class FeaturedVideo(Base, TimestampMixin):

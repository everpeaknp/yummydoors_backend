...
from sqlalchemy import Boolean, Float, ForeignKey, Integer, String, Enum as SQLEnum
...
if TYPE_CHECKING:
    from app.modules.restaurants.models import Restaurant, Category
...
class MenuItem(Base, TimestampMixin):
    ...
    modifier_groups: Mapped[list["MenuModifierGroup"]] = relationship(back_populates="menu_item", cascade="all, delete-orphan")
...
class MenuModifierGroup(Base):
    ...
    items: Mapped[list["MenuModifierItem"]] = relationship(back_populates="group", cascade="all, delete-orphan")
